...
from gq.layers import CertaintyDiffusion
from gq.utils import apply_mask, storage
...
from gq.utils import Storage, create_storage, ModelNotFoundError
...
class Model(nn.Module):
    ...
    def load_from_file(self, model_path: str) -> None:
        if not torch.cuda.is_available():
            ...
            c = torch.load(model_path, weights_only=False)
